...
| dts-dmo(variables.tf#L207) | Optional prefix used to generate project id and name. | <code>string</code> |  | <code>null</code> |
...
| dmo-test-higashi(outputs.tf#L106) | Project id. |  |
