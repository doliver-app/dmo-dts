...
| dmo-test-higashi(variables.tf#L220) | Bucket project id. | <code>string</code> | ✓ |  |
...
| dts-dmo(variables.tf#L210) | Optional prefix used to generate the bucket name. | <code>string</code> |  | <code>null</code> |
